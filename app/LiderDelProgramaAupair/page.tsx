...
export default function Page() {
  ...
  const imageSrc = "/mujer2.jpg";
  const name = "Maria Claudia Coral";
          ...
          >
            <CardBody>
              <div className="flex flex-col gap-4">
                ...
                <p className="text-small text-foreground/80">Lider del programa Au Pair</p>
                <p className="text-medium font-medium mt-2">
                María Claudia es una persona apasionada por las artes, especialmente por la música y los idiomas.
