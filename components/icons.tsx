...
export const Logo: React.FC<LogoProps> = ({
  size = 36, // Tamaño predeterminado
  ...props // Otras propiedades que desees pasar
}) => {
  return (
    <Image
      src={logo}
      alt="Mi Logo"
      width={size} // Asegúrate de que sea un número
      height={size} // Asegúrate de que sea un número
      className="object-contain mt-16" // Clase para el estilo
      {...props} // Si tienes otras props válidas que necesites
    />
  );
};
